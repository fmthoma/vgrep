...
executeCommand = \case
    ...
    ResultsUp          -> continue (zoom results prevLine)
    ResultsDown        -> continue (zoom results nextLine)
    ResultsPrevMatch   -> continue (zoom results prevMatch)
    ResultsNextMatch   -> continue (zoom results nextMatch)
    ResultsPageUp      -> continue (zoom results pageUp)
    ResultsPageDown    -> continue (zoom results pageDown)
    PrevResult         -> continue (zoom results prevLine)
